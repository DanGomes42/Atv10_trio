...
if (isset($_POST['create'])) {
    ...
    $sql = "INSERT INTO aulas (nome_professor, especialidade, email) VALUES ('$email', '$disciplina', '$sala', '$data_aula', '$atividades', '$observacoes', '$nome_professor')";
...
<table border="1">
    ...
    <tr>
        ...
        <td>
            <a href="atualizar.php?id=<?php echo $row['id']; ?>">Excluir</a>
